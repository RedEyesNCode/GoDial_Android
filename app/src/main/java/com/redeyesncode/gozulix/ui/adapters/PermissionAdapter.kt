...
import com.redeyesncode.gozulix.databinding.ItemPermissionBinding

class PermissionAdapter(var context: Context, var data :ArrayList<PermissionData>,var permission: onPermission) :RecyclerView.Adapter<PermissionAdapter.MyViewholder>(){
