...
import com.redeyesncode.gozulix.data.PermissionData
import com.redeyesncode.gozulix.databinding.ActivityPermissionBinding
import com.redeyesncode.gozulix.dialer.PermissionManager
import com.redeyesncode.gozulix.ui.adapters.PermissionAdapter
...
class PermissionActivity : BaseActivity(),PermissionAdapter.onPermission {
    ...
    private fun setupPermissionAdapter() {
        ...
        val data = PermissionData("PHONE","Phone","This Permission is required to place phone calls",ContextCompat.getDrawable(this@PermissionActivity,R.drawable.baseline_phone_24)!!)
        var dataList = ArrayList<PermissionData>()
        dataList.add(data)
        dataList.add(PermissionData("CONTACT","Contact","This Permission is required to read your contacts, when you choose to import them",ContextCompat.getDrawable(this@PermissionActivity,R.drawable.baseline_account_box_24)!!))
        dataList.add(PermissionData("MICROPHONE","Microphone","This Permission is required to convert your voice notes to text notes.",ContextCompat.getDrawable(this@PermissionActivity,R.drawable.baseline_lock_24)!!))
