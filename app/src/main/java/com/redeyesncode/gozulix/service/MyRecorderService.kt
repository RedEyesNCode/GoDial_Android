    ...
    inner class CallBr : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            try {
                ...
                Toast.makeText(context, "IOException : $outCall", Toast.LENGTH_LONG).show()
            ...
            try {
                ...
                Toast.makeText(context, "RECORDING : $outCall", Toast.LENGTH_LONG).show()

            } catch (e: IllegalStateException) {
                Log.i("SERVICE_RECORDING","IllegalStateException")
                Toast.makeText(context, "IllegalStateException : $outCall", Toast.LENGTH_LONG).show()
